...
namespace Flynt\FeatureAdminComponentScreenshots;
        ...
        add_filter(
            ...
            function ($title, $field, $layout, $i) {
                ...
                if (is_file($componentScreenshotPath)) {
                    ...
                    $newTitle .=
                        '<img class="flyntComponentScreenshot-imageElement" src="' .
                        $componentScreenshotUrl .
                        '" height="36px">';
                    $newTitle .=
                        '<span class="flyntComponentScreenshot-label">' . $title . '</span>';
                    $newTitle .= '</span>';
                    $title = $newTitle;
                }
                return $title;
